      ...
      >
        <ul>
          ...
          <li
            ...
            data-thumb="{{asset('assets/frontend/images/main-slider/slider-2/image-1.jpg')}}"
            data-rotate="0"
          ...
          >
            ...
            <img
              src="{{asset('assets/frontend/images/main-slider/slider-2/image-1.jpg')}}"
              alt=""
            ...
            <div
              ...
              "
            >
              <span class="site-bg-primary rev-banner-2-title1"
                >Welcome To Our Milcandy House.</span
              >
            </div>
            ...
            >
              <span class="site-text-white"
                >Here Get All Natural Products From Us.</span
              >
            ...
            >
              <a href="contact-1.html" class="site-button-outline"
                >discover More
            ...
            <div
              ...
              data-voffset="['50','50','100','100']"
              data-width="['300','300','200','200']"
              data-height="['none','none','none','none']"
              data-basealign="slide"
              data-type="text"
              data-responsive_offset="on"
          ...
          >
            ...
            <img
              src="{{asset('assets/frontend/images/main-slider/slider-2/image-2.jpg')}}"
              alt=""
